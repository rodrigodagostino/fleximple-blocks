        ...
        <style>
          ...
          {!!minHeight.small.value &&
            `.${defaultClassName}.min-height-${
              minHeight.small.value +
              (minHeight.small.unit === '%' ? 'pct' : minHeight.small.unit)
            }--sm > .${defaultClassName}__inner > .${defaultClassName}__content > .block-editor-inner-blocks > .block-editor-block-list__layout {
              min-height: ${minHeight.small.value + minHeight.small.unit};
            }`}
          {!!contentWidth.small.value &&
            `.${defaultClassName}.content-width-${
              contentWidth.small.value +
              (contentWidth.small.unit === '%'
                ? 'pct'
                : contentWidth.small.unit)
          ...
          {(!!alignmentHorizontal.medium ||
            ...
            `@media only screen and (min-width: ${
              ...
              ${
                ...
                .${defaultClassName}.min-height-${
                      minHeight.medium.value +
                      (minHeight.medium.unit === '%'
                        ? 'pct'
                        : minHeight.medium.unit)
                    }--md > .${defaultClassName}__inner > .${defaultClassName}__content > .block-editor-inner-blocks > .block-editor-block-list__layout {
              ...
              ${
                ...
                .${defaultClassName}.content-width-${
                  ...
                  width: ${
                    contentWidth.medium.value + contentWidth.medium.unit
                  };
                }`
                  : ''
              }
              ...
              ${
                (!!focalPoint.medium.x || !!focalPoint.medium.y) &&
                (focalPoint.medium.x !== focalPoint.medium.x ||
                  focalPoint.medium.y !== focalPoint.medium.y)
                  ? `
                .${defaultClassName}.background-position-${
              ...
              ${
                !!backgroundSize.medium &&
                backgroundSize.medium !== backgroundSize.medium
                  ? `
              ...
              ${
                !!backgroundRepeat.medium &&
                backgroundRepeat.medium !== backgroundRepeat.medium
                  ? `
          ...
          {(!!alignmentHorizontal.large ||
            ...
            `@media only screen and (min-width: ${
              ...
              ${
                ...
                .${defaultClassName}.min-height-${
                      minHeight.large.value +
                      (minHeight.large.unit === '%'
                        ? 'pct'
                        : minHeight.large.unit)
                    }--lg > .${defaultClassName}__inner > .${defaultClassName}__content > .block-editor-inner-blocks > .block-editor-block-list__layout {
