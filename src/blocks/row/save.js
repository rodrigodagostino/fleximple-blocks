      ...
      <style>
        ...
        {!!minHeight.small.value &&
          `.${defaultClassName}.min-height-${
            minHeight.small.value +
            (minHeight.small.unit === '%' ? 'pct' : minHeight.small.unit)
          }--sm > .${defaultClassName}__inner > .${defaultClassName}__content {
            ...
            ${
              ...
              .${defaultClassName}.min-height-${
                    ...
                    (minHeight.medium.unit === '%'
                      ? 'pct'
                      : minHeight.medium.unit)
                  }--md > .${defaultClassName}__inner > .${defaultClassName}__content {
            ...
            ${
              ...
              .${defaultClassName}.min-height-${
                    ...
                    (minHeight.large.unit === '%'
                      ? 'pct'
                      : minHeight.large.unit)
                  }--lg > .${defaultClassName}__inner > .${defaultClassName}__content {
