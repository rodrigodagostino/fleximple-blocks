...
function DateAndTimeEdit({
  ...
  function splitDate() {
    const date = dateI18n(
      dateFormat !== 'custom' ? dateFormat : customDateFormat,
      getDate()
    )
  ...
  function splitTime() {
    const time = dateI18n(
      timeFormat !== 'custom' ? timeFormat : customTimeFormat,
      getDate()
    )
              ...
              {dateFormat === 'custom' && (
                <TextControl
                  ...
                  help={
                    <ExternalLink
                      href={
                        'https://es.wordpress.org/support/article/formatting-date-and-time/'
                      }
                    >
                      {__(
