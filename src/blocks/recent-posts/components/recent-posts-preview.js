...
const RecentPostsPreview = ({
  ...
  const classes = classnames({
    ...
    [ `col-${ columns.medium }--md` ]: layout === 'grid' && columns.medium !== columns.small,
    [ `col-${ columns.large }--lg` ]: layout === 'grid' && columns.large !== columns.medium,
    [ `gap-row-${ gapRow.small.value + ( gapRow.small.unit === '%' ? 'pct' : gapRow.small.unit ) }--sm` ]: gapRow.small.value,
    [ `gap-row-${ gapRow.medium.value + ( gapRow.medium.unit === '%' ? 'pct' : gapRow.medium.unit ) }--md` ]: gapRow.medium.value,
    [ `gap-row-${ gapRow.large.value + ( gapRow.large.unit === '%' ? 'pct' : gapRow.large.unit ) }--lg` ]: gapRow.large.value,
    [ `gap-column-${ gapColumn.small.value + ( gapColumn.small.unit === '%' ? 'pct' : gapColumn.small.unit ) }--sm` ]: gapColumn.small.value,
    [ `gap-column-${ gapColumn.medium.value + ( gapColumn.medium.unit === '%' ? 'pct' : gapColumn.medium.unit ) }--md` ]: gapColumn.medium.value,
    [ `gap-column-${ gapColumn.large.value + ( gapColumn.large.unit === '%' ? 'pct' : gapColumn.large.unit ) }--lg` ]: gapColumn.large.value,
  })
      ...
      <style>
        { ( !!columns.small || !!aspectRatio.small ) &&
					...
					${ 'grid' === layout && !!gapRow.small.value ? `
						.fleximple-block-recent-posts.gap-row-${ gapRow.small.value + ( gapRow.small.unit === '%' ? 'pct' : gapRow.small.unit ) }--sm {
							grid-row-gap: ${ gapRow.small.value + gapRow.small.unit };
						}` : '' }
					${ 'grid' === layout && !!gapColumn.small.value ? `
						.fleximple-block-recent-posts.gap-column-${ gapColumn.small.value + gapColumn.small.unit === '%' ? 'pct' : gapColumn.small.unit }--sm {
        ...
        { ( !!columns.medium || !!aspectRatio.large ) &&
					`@media only screen and (min-width: ${ fleximpleblocksPluginData.settings.mediumBreakpointValue }px) {
						...
						${ 'grid' === layout && !!gapRow.medium.value ? `
							.fleximple-block-recent-posts.gap-row-${ gapRow.medium.value + ( gapRow.medium.unit === '%' ? 'pct' : gapRow.medium.unit ) }--md {
								grid-row-gap: ${ gapRow.medium.value + gapRow.medium.unit };
						}` : '' }
						${ 'grid' === layout && !!gapColumn.medium.value ? `
							.fleximple-block-recent-posts.gap-column-${ gapColumn.medium.value + ( gapColumn.medium.unit === '%' ? 'pct' : gapColumn.medium.unit ) }--md {
        ...
        { !!columns.large &&
					`@media only screen and (min-width: ${ fleximpleblocksPluginData.settings.largeBreakpointValue }px) {
						...
						${ 'grid' === layout && !!gapRow.large.value ? `
							.fleximple-block-recent-posts.gap-row-${ gapRow.large.value + ( gapRow.large.unit === '%' ? 'pct' : gapRow.large.unit ) }--lg {
								grid-row-gap: ${ gapRow.large.value + gapRow.large.unit };
							}` : '' }
						${ 'grid' === layout && !!gapColumn.large.value ? `
							.fleximple-block-recent-posts.gap-column-${ gapColumn.large.value + ( gapColumn.large.unit === '%' ? 'pct' : gapColumn.large.unit ) }--lg {
