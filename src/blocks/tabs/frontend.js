...
tabsBlockInstances.forEach( instance => {
	instance.querySelector( '.fleximple-block-tabs__panel-list .fleximple-block-tab-panel' ).classList.add( 'is-active' )
} )

const tabs = document.querySelectorAll( '.fleximple-block-tabs .fleximple-block-tabs__tab' )
tabs.forEach( ( tab, index ) => {
	...
	tab.addEventListener( 'click', function () {
		...
		const tabPanels = tab.closest( '.fleximple-block-tabs' ).querySelectorAll( '.fleximple-block-tab-panel' )
