...
export const settings = {
	title: __( 'Tab Panel' ),
	description: __( 'The single unit that works as the main structural component for the tabs block.', 'fleximpleblocks' ),
	...
	edit: ( props ) => {
		...
		const TEMPLATE = [
			[ 'core/paragraph', { placeholder: __( 'Add content…', 'fleximpleblocks' ) } ],
		]
