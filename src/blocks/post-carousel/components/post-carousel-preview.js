...
const PostCarouselPreview = ( {
	...
	const contentClasses = classnames(
		`${ defaultClassName }__entry-content`, {
	...
	const buttonPrevClasses = classnames(
		'swiper-button-prev', {
	...
	const swiperParams = {
		...
		renderPrevButton: () => <button className={ buttonPrevClasses } style={ buttonPrevStyles }>
			<span className="screen-reader-only">{ __( 'Previous slide', 'fleximpleblocks' ) }</span>
			<i className={ buttonPrevIconClasses } aria-hidden="true" />
		</button>,
		renderNextButton: () => <button className={ buttonNextClasses } style={ buttonNextStyles }>
			<span className="screen-reader-only">{ __( 'Next slide', 'fleximpleblocks' ) }</span>
	...
	return (
		<div { ...blockProps }>
			<Swiper { ...swiperParams } rebuildOnUpdate={ true }>
