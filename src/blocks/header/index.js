...
export const settings = {
	...
	description: __( 'Introduce new sections and organize content to help visitors (and search engines) better understand the structure of your site.', 'fleximpleblocks' ),
	icon,
	keywords: [
