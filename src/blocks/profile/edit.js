...
function ProfileEdit({
  ...
  return (
    <>
              ...
              <>
                ...
                <ToggleControl
                  ...
                  onChange={ () => {
                    ...
                    if ( direction[ tab.name ] === 'row' && !!isReversed[ tab.name ] ) {
                      setResponsiveAttribute(
                        attributes,
                        setAttributes,
                        'textAlignment',
                    ...
                    } else if ( direction[ tab.name ] === 'row' && !isReversed[ tab.name ] ) {
                      setResponsiveAttribute(
                        attributes,
                        setAttributes,
                        'textAlignment',
      ...
      <div { ...blockProps }>
        <style>
          { `.${ defaultClassName }.text-align-${ textAlignment.small }--sm .fleximple-components__media-placeholder {
              ${ 'margin-left: ' + ( textAlignment.small === 'left' ? '0' : 'auto' ) + ';' }
              ${ 'margin-right: ' + ( textAlignment.small === 'right' ? '0' : 'auto' ) + ';' }
            }
            .${ defaultClassName }.media-gap-${ mediaGap.small.value + ( mediaGap.small.unit === '%' ? 'pct' : mediaGap.small.unit ) }--sm.direction-${ direction.small === 'row' ? 'h' : 'v' }--sm${ isReversed.small ? '.is-reversed--sm' : '' } .${ defaultClassName }__media,
            .${ defaultClassName }.media-gap-${ mediaGap.small.value + ( mediaGap.small.unit === '%' ? 'pct' : mediaGap.small.unit ) }--sm.direction-${ direction.small === 'row' ? 'h' : 'v' }--sm${ isReversed.small ? '.is-reversed--sm' : '' } .fleximple-components__media-placeholder {
              ${ direction.small === 'row' && isReversed.small !== true ? 'margin-right: ' + mediaGap.small.value + mediaGap.small.unit + ';' : '' }
              ${ direction.small === 'row' && isReversed.small === true ? 'margin-left: ' + mediaGap.small.value + mediaGap.small.unit + ';' : '' }
              ${ direction.small === 'column' && isReversed.small !== true ? 'margin-bottom: ' + mediaGap.small.value + mediaGap.small.unit + ';' : '' }
              ${ direction.small === 'column' && isReversed.small === true ? 'margin-top: ' + mediaGap.small.value + mediaGap.small.unit + ';' : '' }
            }
            .${ defaultClassName }.content-gap-${ contentGap.small.value + ( contentGap.small.unit === '%' ? 'pct' : contentGap.small.unit ) }--sm .${ defaultClassName }__content > .block-editor-inner-blocks > .block-editor-block-list__layout > * {
          ...
          { ( !!textAlignment.medium || !!mediaGap.medium.value || !!contentGap.medium.value || !!mediaWidth.medium.value || !!mediaHeight.medium.value || !!mediaBorderRadius.medium.value ) &&
            ...
            ${ textAlignment.medium ? `
              .${ defaultClassName }.text-align-${ textAlignment.medium }--md .fleximple-components__media-placeholder {
                ${ 'margin-left: ' + ( textAlignment.medium === 'left' ? '0' : 'auto' ) + ';' }
                ${ 'margin-right: ' + ( textAlignment.medium === 'right' ? '0' : 'auto' ) + ';' }
              }` : '' }
            ${ mediaGap.medium.value ? `
              .${ defaultClassName }.media-gap-${ mediaGap.medium.value + ( mediaGap.medium.unit === '%' ? 'pct' : mediaGap.medium.unit ) }--md.direction-${ direction.medium === 'row' ? 'h' : 'v' }--md${ isReversed.medium ? '.is-reversed--md' : '' } .${ defaultClassName }__media,
              .${ defaultClassName }.media-gap-${ mediaGap.medium.value + ( mediaGap.medium.unit === '%' ? 'pct' : mediaGap.medium.unit ) }--md.direction-${ direction.medium === 'row' ? 'h' : 'v' }--md${ isReversed.medium ? '.is-reversed--md' : '' } .fleximple-components__media-placeholder {
                ${ direction.medium === 'row' && isReversed.medium !== true ? 'margin-right: ' + mediaGap.medium.value + mediaGap.medium.unit + ';' : '' }
                ${ direction.medium === 'row' && isReversed.medium === true ? 'margin-left: ' + mediaGap.medium.value + mediaGap.medium.unit + ';' : '' }
                ${ direction.medium === 'column' && isReversed.medium !== true ? 'margin-bottom: ' + mediaGap.medium.value + mediaGap.medium.unit + ';' : '' }
                ${ direction.medium === 'column' && isReversed.medium === true ? 'margin-top: ' + mediaGap.medium.value + mediaGap.medium.unit + ';' : '' }
              }` : '' }
            ${ contentGap.medium.value ? `
              .${ defaultClassName }.content-gap-${ contentGap.medium.value + ( contentGap.medium.unit === '%' ? 'pct' : contentGap.medium.unit ) }--md .${ defaultClassName }__content > .block-editor-inner-blocks > .block-editor-block-list__layout > * {
          ...
          { ( !!textAlignment.large || !!mediaGap.large.value || !!contentGap.large.value || !!mediaWidth.large.value || !!mediaHeight.large.value || !!mediaBorderRadius.large.value ) &&
            ...
            ${ textAlignment.large ? `
              .${ defaultClassName }.text-align-${ textAlignment.large }--lg .fleximple-components__media-placeholder {
                ${ 'margin-left: ' + ( textAlignment.large === 'left' ? '0' : 'auto' ) + ';' }
                ${ 'margin-right: ' + ( textAlignment.large === 'right' ? '0' : 'auto' ) + ';' }
              }` : '' }
            ${ mediaGap.large.value ? `
              .${ defaultClassName }.media-gap-${ mediaGap.large.value + ( mediaGap.large.unit === '%' ? 'pct' : mediaGap.large.unit ) }--lg.direction-${ direction.large === 'row' ? 'h' : 'v' }--lg${ isReversed.large ? '.is-reversed--lg' : '' } .${ defaultClassName }__media,
              .${ defaultClassName }.media-gap-${ mediaGap.large.value + ( mediaGap.large.unit === '%' ? 'pct' : mediaGap.large.unit ) }--lg.direction-${ direction.large === 'row' ? 'h' : 'v' }--lg${ isReversed.large ? '.is-reversed--lg' : '' } .${ defaultClassName }__media {
                ${ direction.large === 'row' && isReversed.large !== true ? 'margin-right: ' + mediaGap.large.value + mediaGap.large.unit + ';' : '' }
                ${ direction.large === 'row' && isReversed.large === true ? 'margin-left: ' + mediaGap.large.value + mediaGap.large.unit + ';' : '' }
                ${ direction.large === 'column' && isReversed.large !== true ? 'margin-bottom: ' + mediaGap.large.value + mediaGap.large.unit + ';' : '' }
                ${ direction.large === 'column' && isReversed.large === true ? 'margin-top: ' + mediaGap.large.value + mediaGap.large.unit + ';' : '' }
              }` : '' }
            ${ contentGap.large.value ? `
              .${ defaultClassName }.content-gap-${ contentGap.large.value + ( contentGap.large.unit === '%' ? 'pct' : contentGap.large.unit ) }--lg .${ defaultClassName }__content > .block-editor-inner-blocks > .block-editor-block-list__layout > * {
            ...
            ${ mediaWidth.large.value ? `
              .${ defaultClassName }.media-width-${ mediaWidth.large.value + ( mediaWidth.large.unit === '%' ? 'pct' : mediaWidth.large.unit ) }--md .${ defaultClassName }__media {
                width: ${ mediaWidth.large.value + mediaWidth.large.unit };
              }` : '' }
            ${ mediaHeight.large.value ? `
              .${ defaultClassName }.media-height-${ mediaHeight.large.value + ( mediaHeight.large.unit === '%' ? 'pct' : mediaHeight.large.unit ) }--md .${ defaultClassName }__media {
          ...
          <figure className={ mediaClasses } style={ mediaStyles }>
            <MediaUploadCheck>
              <MediaUpload
                ...
                value={ mediaId }
                render={ ({ open }) =>
                  <Button className={ !mediaId ? 'button button-hero' : '' } onClick={ open }>
                    { !mediaId ?
                      __( 'Choose profile image', 'fleximpleblocks' ) :
                      <img className={ `${ defaultClassName }__image` } src={ mediaUrl } alt={ mediaAlt } />
                    }
                  </Button>
                }
              />
