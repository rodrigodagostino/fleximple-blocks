...
function ProfileSave({
  ...
  return (
    <div { ...blockProps }>
      <style>
        { `.${ defaultClassName }.text-align-${ textAlignment.small }--sm .${ defaultClassName }__media {
        ...
        { `.${ defaultClassName }.content-gap-${ contentGap.small.value + ( contentGap.small.unit === '%' ? 'pct' : contentGap.small.unit ) }--sm .${ defaultClassName }__content > * {
      ...
      `.${ defaultClassName }.content-gap-${ contentGap.medium.value + ( contentGap.medium.unit === '%' ? 'pct' : contentGap.medium.unit ) }--md .${ defaultClassName }__content > * {
      ...
      `.${ defaultClassName }.content-gap-${ contentGap.large.value + ( contentGap.large.unit === '%' ? 'pct' : contentGap.large.unit ) }--lg .${ defaultClassName }__content > * {
