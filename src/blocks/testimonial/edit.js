				...
				<div className={ classes }>
					<style>
						...
						{ !! mediaHeight.small.value ?
							`.${ defaultClassName }.media-height-${ mediaHeight.small.value + ( mediaHeight.small.unit === '%' ? 'pct' : mediaHeight.small.unit ) }--sm .${ defaultClassName }__media .${ defaultClassName }__image {
						...
						{ ( !! gap.medium.value || !! mediaHeight.medium.value || !! mediaBorderRadius.medium.value ) && (
							...
							${ !! mediaHeight.medium.value ?
								`.${ defaultClassName }.media-height-${ mediaHeight.medium.value + ( mediaHeight.medium.unit === '%' ? 'pct' : mediaHeight.medium.unit ) }--md .${ defaultClassName }__media .${ defaultClassName }__image {
						...
						{ ( !! gap.large.value || !! mediaHeight.large.value || !! mediaBorderRadius.large.value ) && (
							...
							${ !! mediaHeight.large.value ?
								`.${ defaultClassName }.media-height-${ mediaHeight.large.value + ( mediaHeight.large.unit === '%' ? 'pct' : mediaHeight.large.unit ) }--lg .${ defaultClassName }__media .${ defaultClassName }__image {
												...
												<MediaUpload
													...
													render={ ( { open } ) => (
														<Button
															...
															onClick={ open }>
															{ ! mediaId ?
																__( 'Choose testimonial image', 'fleximpleblocks' ) :
