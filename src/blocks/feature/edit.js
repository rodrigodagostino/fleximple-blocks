            ...
            {url && (
              <>
                <TextControl
                  ...
                  help={__(
                    'Here you can provide a brief explanation about the link’s destination, which is meant to be used by screen readers.',
                    'fleximpleblocks'
                  )}
                />
        ...
        <div className={classes}>
          <style>
            {`.${defaultClassName}.content-gap-${
              contentGap.small.value +
              (contentGap.small.unit === '%' ? 'pct' : contentGap.small.unit)
            }--sm .${defaultClassName}__inner > .block-editor-inner-blocks > .block-editor-block-list__layout > * {
                ...
                contentGap.medium.value
                  ? `.${defaultClassName}.content-gap-${
                      ...
                      (contentGap.medium.unit === '%'
                        ? 'pct'
                        : contentGap.medium.unit)
                    }--md .${defaultClassName}__inner > .block-editor-inner-blocks > .block-editor-block-list__layout > * {
