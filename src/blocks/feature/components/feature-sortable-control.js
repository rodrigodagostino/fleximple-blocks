...
class FeatureSortableControl extends Component {
	...
	toggleAttribute( attribute ) {
		if ( 'heading' === attribute ) {
			this.props.setAttributes( { displayHeading: ! this.props.attributes.displayHeading } )
		}
		if ( 'subhead' === attribute ) {
			this.props.setAttributes( { displaySubhead: ! this.props.attributes.displaySubhead } )
		}
		if ( 'additional' === attribute ) {
			this.props.setAttributes( { displayAdditional: ! this.props.attributes.displayAdditional } )
		}
	}
