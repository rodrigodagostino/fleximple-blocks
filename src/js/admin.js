...
import { ExternalLink, Button, PanelBody, Placeholder, TextControl, ToggleControl } from '@wordpress/components'
		...
		wp.api.loadPromise.then( () => {
			...
			if ( false === this.state.isAPILoaded ) {
				this.settings.fetch().then( response => {
					this.setState( {
						fleximpleblocks_small_breakpoint_value: response.fleximpleblocks_small_breakpoint_value,
						fleximpleblocks_medium_breakpoint_value: response.fleximpleblocks_medium_breakpoint_value,
						fleximpleblocks_large_breakpoint_value: response.fleximpleblocks_large_breakpoint_value,
						fleximpleblocks_xlarge_breakpoint_value: response.fleximpleblocks_xlarge_breakpoint_value,
						fleximpleblocks_is_font_awesome_active: response.fleximpleblocks_is_font_awesome_active,
						fleximpleblocks_is_leaflet_active: response.fleximpleblocks_is_leaflet_active,
						fleximpleblocks_is_swiper_active: response.fleximpleblocks_is_swiper_active,
						fleximpleblocks_open_weather_api_key: response.fleximpleblocks_open_weather_api_key,
						isAPILoaded: true,
					} )
				} )
			}
					...
					<PanelBody title={ __( 'Breakpoints', 'fleximpleblocks' ) }>
						...
						<div className="fleximple-components-control__row">
							<TextControl
								...
								onChange={ value => this.setState( { fleximpleblocks_small_breakpoint_value: value } ) }
							...
							<TextControl
								...
								onChange={ value => this.setState( { fleximpleblocks_medium_breakpoint_value: value } ) }
								disabled={ this.state.isAPISaving }
								min={ 0 }
							/>
							...
							<TextControl
								...
								onChange={ value => this.setState( { fleximpleblocks_large_breakpoint_value: value } ) }
								disabled={ this.state.isAPISaving }
								min={ 0 }
							/>
							...
							<TextControl
								...
								onChange={ value => this.setState( { fleximpleblocks_xlarge_breakpoint_value: value } ) }
								disabled={ this.state.isAPISaving }
								min={ 0 }
							/>
						</div>
					...
					<PanelBody title={ __( 'Third Parties', 'fleximpleblocks' ) }>
						<div className="fleximple-components-control__row">
							<ToggleControl
								...
								onChange={ () => {
									this.setState( { fleximpleblocks_is_font_awesome_active: !this.state.fleximpleblocks_is_font_awesome_active } )
								} }
								help={ __( 'It’s only necessary for icons to work. Deactivate it if you won’t be using them.', 'fleximpleblocks' ) }
							/>
						</div>
						...
						<div className="fleximple-components-control__row">
							<ToggleControl
								...
								onChange={ () => {
									this.setState( { fleximpleblocks_is_leaflet_active: !this.state.fleximpleblocks_is_leaflet_active } )
								} }
								help={ __( 'It’s only necessary for maps to work. Deactivate it if you won’t be using them.', 'fleximpleblocks' ) }
							/>
						</div>
						...
						<div className="fleximple-components-control__row">
							<ToggleControl
								...
								onChange={ () => {
									this.setState( { fleximpleblocks_is_swiper_active: !this.state.fleximpleblocks_is_swiper_active } )
								} }
								help={ __( 'It’s only necessary for carousels to work. Deactivate it if you won’t be using them.', 'fleximpleblocks' ) }
							/>
						</div>
						...
						<div className="fleximple-components-control__row">
							<TextControl
								...
								onChange={ value => this.setState( { fleximpleblocks_open_weather_api_key: value } ) }
								help={
...
domReady( () => {
	render( <FleximpleBlocksSettings />, document.querySelector( '#fleximple-blocks-settings-page' ) )
} )
